...
parser.add_option('--threshold', type=float, default=0, help="Threshold of weights. Default is zero, means no threshold.")
...
process = LiveProcess()
process.cmd = ['tests/test-progs/simplecnn/main', str(options.threshold)]
